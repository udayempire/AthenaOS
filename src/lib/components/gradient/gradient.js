...
class Gradient {
  constructor(...t) {
    e(this, "el", void 0),
      ...
      e(this, "resizeTimeout", null), // Add a timeout property for debouncing

      e(this, "resize", () => {
        // Pause the animation during resize
        this.conf.playing = false;

        // Clear any existing timeout
        clearTimeout(this.resizeTimeout);

        // Set a timeout to resume animation after resizing is complete
